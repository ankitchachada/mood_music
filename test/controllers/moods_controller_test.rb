...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference('Mood.count') do
      post moods_url, params: { mood: { input_url: @mood.input_url, output_url: @mood.output_url, status: @mood.status } }
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { input_url: @mood.input_url, output_url: @mood.output_url, status: @mood.status } }
